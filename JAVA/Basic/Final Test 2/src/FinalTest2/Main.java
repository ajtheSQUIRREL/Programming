...
public class Main {
    ...
    public static void main(String[] args) {
        ArrayList<Rose.Tulip.Flower> fList = new ArrayList();
        fList.add(new Rose.Tulip.Flower(new Rose("Pink")));
        fList.add(new Rose.Tulip.Flower(new Rose("Red", 200)));
        fList.add(new Rose.Tulip.Flower(new Rose.Tulip("Blue")));
        fList.add(new Rose.Tulip.Flower(new Rose.Tulip("White", 300)));
        for (Rose.Tulip.Flower f : fList) {
